...
2. **Feature engineering**: derive time-based features (e.g., year, month, days since 2020) and encode categorical variables.
...
5. **Validation**: use time-series-aware splits (e.g., train on 2020–2022, validate on 2023–2024) to avoid look-ahead bias.
